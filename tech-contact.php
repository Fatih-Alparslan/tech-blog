                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <form class="form-wrapper">
                                        ...
                                        <textarea class="form-control" placeholder="Mesajın"></textarea>
                                        <button type="submit" class="btn btn-primary" role="button">Gönder <i class="fa fa-envelope-open-o"></i></button>
                                    </form>
                                </div>
                            </div>
